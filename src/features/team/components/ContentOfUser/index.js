...
export default function ContentOfUser() {
  ...
  return (
    <Stack styles={contentArea}>
      <Text styles={titleOfContent}>Most Used Content</Text>
      <Pivot aria-label="Base example Pivot" defaultSelectedKey="thirtyDays" styles={pivotStatusStyles}>
            ...
            emptyContent
              ? () => (
                  <TooltipHost
                    content={
                      <Stack>
                        <Text styles={titleTipHost}>No links created in the last 7 days.</Text>
                      </Stack>
                    }
        ...
        >
          <ContentTable days={7} userId={userId} handleBlockEmptyContent={_handleEmptyContent} />
        </PivotItem>
        <PivotItem headerText="Last 30 days" itemKey="thirtyDays">
          <ContentTable days={30} userId={userId} handleBlockEmptyContent={_handleEmptyContent} />
        </PivotItem>
      </Pivot>
    </Stack>
  );
